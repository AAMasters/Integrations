function newLayer() {
    ...
    function initialize(callBackFunction) {
        ...
        try {
            ...
            if (UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Data Product', undefined, false, true, true, true) === undefined) {
                thisObject.payload.uiObject.setErrorMessage('Data Product not Found')
                return
            }
            if (UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Market', undefined, false, true, true, true) === undefined) {
                thisObject.payload.uiObject.setErrorMessage('Market not Found')
                return
            }

            thisObject.productDefinition = UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Product Definition', undefined, false, true, true, true)
            ...
            thisObject.exchange = UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Crypto Exchange', undefined, false, true, true, true)
            if (thisObject.exchange === undefined) {
                thisObject.payload.uiObject.setErrorMessage('Crypto Exchange not Found')
                return
            }

            thisObject.baseAsset = UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Market Base Asset', undefined, false, true, true, true)
            ...
            thisObject.quotedAsset = UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Market Quoted Asset', undefined, false, true, true, true)
            ...
            thisObject.plotterModule = UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Plotter Module', undefined, false, false, false, true)
            if (thisObject.plotterModule === undefined) {
                thisObject.payload.uiObject.setErrorMessage('Plotter Module not Found')
                return
            }

            thisObject.networkNode = UI.projects.superalgos.utilities.meshes.findNodeInNodeMesh(thisObject.definition, 'Network Node', undefined, false, true, true, true)
